...
class TweetBox extends React.Component {
    render() {
      return(/*,border:"1px solid #00c0ef"*/
            <div style={{display:'inline-block',verticalAlign: "top",borderRadius:'10',width:'300px',height:'100px',marginRight:'350px',marginTop:'120px',marginLeft:'50px'}}>
